...
an intermediate frequency. This done by selecting a local oscillator %
(LO) frequency to be the same as the centre frequency of the %
bandpass signal.
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{./Figures/System/%
...
described in chapter \ref{chap:AdaptiveFiltering}.
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.6\textwidth]{./Figures/System/%
